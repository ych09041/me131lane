...
#define RIGHT_LANE        45

// controller gains
#define STEERING_KP     0.6
#define STEERING_KD     0.07
#define VELOCITY_KP     0.025
#define VELOCITY_KI     0.055
...
#define MIN_THROTTLE  94

// ultrasonic obstacle detection thresholds
#define FRONT_SPACE   0.70  // meters
#define SIDE_SPACE    0.40
...
float lastInput =0.0;
float MOTORINTEGRALMIN = -0.6;
float MOTORINTEGRALMAX = 0.6;
float TICKTOMETERS = 0.07253/4.0*3.1415;
float currPos = 0.0;
float prevPos = 0.0;
...
//  Serial.println(error);
  ...
  /*Compute PID Output*/
  float output = (VELOCITY_KP*error + ITerm- VELOCITY_KD*dInput/(LOOP_PERIOD*MOTOR_LOOP_N));
